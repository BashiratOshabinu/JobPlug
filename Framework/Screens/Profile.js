...
export function Profile({navigation}) {
    ...
    return (
        ...
        borderRadius: 10,
        marginVertical: 20,
        backgroundColor:"black"}} onPress={() => navigation.navigate("Funds")}>
          ...
          <View style={{ backgroundColor: "white", width: '70%',height: 170, borderRadius: 10, paddingHorizontal:10,padding:20, justifyContent: "center",alignSelf: "center",
        }}>
