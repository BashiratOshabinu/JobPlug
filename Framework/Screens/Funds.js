...
export function Funds({ navigation }) {
          ...
          {(prop) => {
            return (
              <View style={styles.form}>
                ...
                <Image source={require ("../../assets/Cc.png") } style={{ width: 60, height: 60, }} />
                </View>
                  <Text style={styles.header}>Paystack Card</Text>
                <View style={{ alignItems: "center" }}>
                  <Image source={require ("../../assets/Peecc.png") } style={{ width: 400, height: 400, }} />
                </View>
              ...
              <View style={{ marginBottom: 20 }}>
                ...
                <View style={{ marginTop: 20, margin: 15, }}>
                  ...
                  <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                    ...
                    <Text style={[styles.modalText, { color: Theme.colors.primary, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>Paystack</Text>
                  </View>
                  ...
                  <View style={{ alignItems: 'center', marginBottom: 20, justifyContent: "space-between", flexDirection: "row" }}>
                    ...
                    <Text style={[styles.modalText, { color: Theme.colors.primary, fontSize: 20, fontWeight: "bold", fontFamily: null }]}>₦{formatMoney(amount)}</Text>
                  </View>
